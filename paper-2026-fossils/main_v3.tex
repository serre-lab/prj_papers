...
\documentclass[pdflatex,lineno,sn-mathphys-num]{sn-jnl}% Math and Physical Sciences Numbered Reference Style 
...
\affil*[1]{\orgdiv{Department of Cognitive \& Psychological Sciences}, \orgname{Brown University}, \orgaddress{ \city{Providence},  \state{Rhode Island}, \country{USA}}}

\affil[2]{\orgdiv{Kempner Institute}, \orgname{Harvard University}, \orgaddress{ \city{Boston}, \state{Massachusetts}, \country{USA}}}

\affil[3]{\orgdiv{Florissant Fossil Beds National Monument (Emeritus)}, \orgname{National Park Service}, \orgaddress{ \city{Florissant},  \state{Colorado}, \country{USA}}}
