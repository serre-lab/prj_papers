...
\begin{figure}[H]
    \centering\includegraphics[width=.99\linewidth]{Figures/Figure_1_v8.png}
...
\includegraphics[width=.7\linewidth]{Figures/Figure_6_v2.jpg}
    \caption{Examples of visual ``concepts'' used by the model for classification. Concept 1596: active on the leaf margin. Concept 1792: active in intercostal areas. Concept 129: activates at junctions between primary and secondary veins. Concept 90: activates as leaf base. Additional examples shown on Fig.~\ref{fig:SI_concepts,fig:SI_concepts2}. Full set available at \url{https://fel-thomas.github.io/Leaf-Lens/} .} 
    \label{fig:concepts}
\end{figure}
